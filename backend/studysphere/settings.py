...
SECRET_KEY = 'django-insecure-s-87xufu3@dqmbx^3!3#k+_2yv#ycyc%9e!mx^!_w+%wh$(#$y'
...
CSRF_TRUSTED_ORIGINS = ['https://studysphere-awva.onrender.com']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'sYsTXpAnGTWjJDpKolpnrABiipQvSAhx',
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'sidchan70@gmail.com'
...
DJOSER = {
    ...
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': ['https://studysphere-awva.onrender.com/google'],
    'SERIALIZERS': {
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = config('KEY')
...
CORS_ALLOWED_ORIGINS = [
    "https://studysphere-awva.onrender.com",
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
